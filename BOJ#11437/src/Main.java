...
public class Main {
	...
	public static void main(String[] args) {
		...
		//이 방법은 깊이가 0인지 아닌지에 따라 자식노드 발견여부를 판단하기때문에 루트노드의 깊이를 1로 시작함
		dfs(1, 1); //1이 루트노드이기 때문에 1부터 시작 -> 노드들의 깊이와 부모노드를 알아내기 위해 dfs 사용
		
//		dfs2(1, 0, -1); //깊이는 0으로 시작해도되고 1로 시작해도됨
...
//		}
	...
	//깊이와 부모노드를 알아내는 다른 방법
	public static void dfs2(int v, int d, int p) {
		depth[v] = d;
		parent[v] = p;
